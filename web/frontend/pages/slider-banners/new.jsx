...
const TRANSITION_EFFECTS = [
  ...
  // Vertical stripes - grow into each other
  ...
  // Vertical stripes - move into each other
  ...
  // Horizontal stripes - grow left to right
  ...
  // Horizontal stripes - move left to right
  ...
  // Horizontal stripes - grow right to left
  ...
  // Horizontal stripes - move right to left
  ...
  // Horizontal stripes - grow into each other
  ...
  // Horizontal stripes - move into each other
...
export default function CreateSliderBanner() {
  const { t } = useTranslation();
  ...
  return (
    <Page
      title={t("SliderBanner.create.title")}
